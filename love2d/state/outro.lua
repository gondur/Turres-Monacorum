...
o.draw = function()
	o.vertBackground0 = {
		...
		{ love.graphics.getWidth(), 0, love.graphics.getWidth() / o.imgBackground0:getWidth() - o.showTimer * 0.1, -o.showTimer * 0.2, 255, 255, 255, 63 },
		{ love.graphics.getWidth(), love.graphics.getHeight(), love.graphics.getWidth() / o.imgBackground0:getWidth() - o.showTimer * 0.1, love.graphics.getHeight() / o.imgBackground0:getHeight() - o.showTimer * 0.2, 255, 255, 255, 127 },
		{ 0, love.graphics.getHeight(), - o.showTimer * 0.1, love.graphics.getHeight() / o.imgBackground0:getHeight() - o.showTimer * 0.2, 255, 255, 255, 127 },
	}
	...
	love.graphics.setColor(255, 255, 255)
	local sx = love.graphics.getWidth() * 0.5 - o.imgBackground1:getWidth() * 0.5
	local sy = love.graphics.getHeight() * 0.5 - o.imgBackground1:getHeight() * 0.5
	love.graphics.draw(o.imgBackground1, sx, sy)
	love.graphics.setFont(o.fontTitle)
	love.graphics.setColor(63, 63, 63)
	love.graphics.printf("Created with:", 0, love.graphics.getHeight() * 0.5 - o.imgBackground1:getHeight() - 8, love.graphics.getWidth(), "center")
end
