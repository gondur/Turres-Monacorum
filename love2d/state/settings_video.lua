...
o.draw = function()
	...
	love.graphics.printf("Video", 4, 24 + 4, love.graphics.getWidth(), "center")
	love.graphics.setColor(255, 127, 0)
	love.graphics.setBlendMode("add")
	love.graphics.printf("Video", 0, 24, love.graphics.getWidth(), "center")
...
o.refreshScreenSize = function()
	...
	o.btnDisplay.setPosition(startx, starty + 64 * 0)
	o.btnShaders.setPosition(startx, starty + 64 * 1)
